...
async def create_user(
    ...
    try:
        ...
        return UserResponse(
            ...
            metadata={"created_by": current_user.id, "version": "v1"},
        )
...
async def list_users(
    ...
    logger.info(
        f"Listing users",
        extra={"page": page, "per_page": per_page, "requested_by": current_user.id},
    )
    ...
    return PaginatedResponse(
        ...
        per_page=per_page,
        pages=result.pages,
        metadata={"sort_by": sort_by, "sort_order": sort_order, "search": search},
    )
