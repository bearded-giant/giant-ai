...
class TestUserService:
    ...
    def test_create_user_valid_data_returns_user(self, user_service, mock_user_data, mock_user):
    ...
    def test_create_user_duplicate_email_raises_error(self, user_service, mock_user_data):
